...
<div class="container-fluid containerall">
  ...
  <div class="row mt-5">
    <div class="col-3">
        <ul class="navbar-nav mr-auto">
            <?php
              ...
              <li class="nav-item"><a class="nav-link" id="<?php echo $topic['id'] ?>" href="topicposts.php?topicid=<?php echo $topic['id']; ?>"><?php echo $topic['img'] ?> <?php echo $topic['name'] ?></a></li>
              <?php }?>
        </ul>
    </div>
    ...
    <div class="col">
          ...
          <?php
          $sqlpost = "SELECT post.*,user.firstname,user.lastname,user.username,user.photo FROM post JOIN user ON post.user_id = user.id WHERE topic_id={$_GET['topicid']}";
                  ...
                  <div class="chat">
                    ...
                    $totale = $result->fetch_assoc();?>
                      ...
                      <form method="post" style="float:right;">
                        ...
                        <button type="submit" name="report" style="background:none; border:none; outline:none;" title="Report post"><i class="fas fa-exclamation-circle ml-2" style="color: grey;"></i></button>
                      </form>
  ...
  echo ' var element = document.getElementById(`' . $_GET["topicid"] . '`);';
  echo 'element.classList.add("current")';
  echo '</script>';
  ?>
